...
/// </summary>
/// 
namespace QuickAsBlink.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["myclientsConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["myclientsConStr"].ConnectionString);
        public CRUD()
        {
            //
